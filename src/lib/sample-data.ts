...
export const SAMPLE_CASHIER_ORDERS: CashierOrder[] = [
  {
    ...
    items: [
      { name: "Kunyit Asam Segar", quantity: 1, sweetnessLevel: "normal", temperature: "ice", price: 15000 },
      { name: "Jahe Merah Madu", quantity: 1, sweetnessLevel: "less", temperature: "hot", price: 18000 },
    ],
  },
  {
    id: "sample-ord-2",
    ...
    items: [
      { name: "Beras Kencur Hangat", quantity: 2, sweetnessLevel: "normal", temperature: null, price: 15000 },
    ],
  },
  {
    id: "sample-ord-3",
    ...
    items: [
      { name: "Wedang Uwuh Rempah", quantity: 1, sweetnessLevel: "no_sugar", temperature: "hot", price: 20000 },
      { name: "Temulawak Sehat", quantity: 1, sweetnessLevel: "low", temperature: null, price: 16000 },
      { name: "Kunyit Asam Segar", quantity: 1, sweetnessLevel: "normal", temperature: "ice", price: 15000 },
    ],
  },
  {
    ...
    items: [
      { name: "Susu Jahe Jamu", quantity: 1, sweetnessLevel: "normal", temperature: "ice", price: 22000 },
    ],
  },
];
